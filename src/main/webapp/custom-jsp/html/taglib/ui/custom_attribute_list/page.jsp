...
<div class="taglib-custom-attributes-list">
	...
	if(attributeNames.contains("attributeNames") || attributeNames.contains("MAPIT_LON")){
		%>
		
		<% 
		for (String attributeName : attributeNames) {
			
			if(!attributeName.equals("MAPIT_LAT") && !attributeName.equals("MAPIT_LAT_HIDDEN")
					&& !attributeName.equals("MAPIT_LON") && !attributeName.equals("MAPIT_LON_HIDDEN")){
			%>
		...
		<liferay-ui:custom-attribute
			...
			editable="<%= editable %>"
			label="<%= label %>"
			name="MAPIT_LON_HIDDEN"
		/>
		<%@ include file="/html/taglib/ui/custom_attribute_geolocation/page.jsp" %>
<%	}else{
